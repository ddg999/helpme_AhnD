...
import helpme_AhnD.ver02.Frame.GameEndFrame_hj;
import helpme_AhnD.ver02.state.Player;
import helpme_AhnD.ver02.utils.Define;

public class ScoreService_hj {
	...
	public ScoreService_hj(DropNoteFrame_hj mContext, Player player) {
	...
	public void beAttacked() {
		if (hp >= Define.HP_0_5_HEART) {
			...
			if (hp == Define.HP_DEATH) {
				...
				new GameEndFrame_hj(mContext, player);
			}
		} else {
			hp = Define.HP_DEATH;
		}
