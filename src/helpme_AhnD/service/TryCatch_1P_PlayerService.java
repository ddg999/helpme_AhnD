...
import helpme_AhnD.frame.TryCatchFrame_1P;
import helpme_AhnD.frame.TryCatchFrame_2P;
import helpme_AhnD.state.KeyType;
import helpme_AhnD.state.Player;

public class TryCatch_1P_PlayerService extends PlayerService {

	GameSelectFrame mContext;
	TryCatchFrame_1P gameFrame;
	Player player;

	private Score score;

	public TryCatch_1P_PlayerService(TryCatchFrame_1P gameFrame, Player player) {
		...
		case RIGHTPLAYER:
			...
			break;
		case SOLO:
			new CatchNote(this, Player.SOLO, KeyType.LEFT);
			new CatchNote(this, Player.SOLO, KeyType.UP);
			new CatchNote(this, Player.SOLO, KeyType.DOWN);
			new CatchNote(this, Player.SOLO, KeyType.RIGHT);
			break;
		default:
			break;
		}
