...
public class GameSelectFrame_jw extends JFrame {
	...
	public GameSelectFrame_jw() {
		initData();
		setInitLayout();
		addEventListener();
	}

	public GameSelectFrame_jw(AhnteacherFrame_modify_jw mContext) {
