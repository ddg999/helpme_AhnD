...
import helpme_AhnD.ver02.Frame.GameEndFrame_kh;
import helpme_AhnD.ver02.Frame.GameSelectFrame;
import helpme_AhnD.ver02.state.Player;
import helpme_AhnD.ver02.utils.Define;

public class ScoreService_kh {
	...
	public ScoreService_kh(DeathNoteFrame mContext, Player player) {
	...
	public void beAttacked() {
		if (hp >= Define.HP_0_5_HEART) {
			...
			if (hp == Define.HP_DEATH) {
				...
				new GameEndFrame_kh(mContext, player);
			}
		} else {
			hp = Define.HP_DEATH;
		}
